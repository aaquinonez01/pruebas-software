...
export const CategoriaForm = () => {
  ...
  const handleSubmit = event => {
    ...
    if(tipoAccion === "Crear"){
categoriaService
    .create({ nombre: categoria.nombre, descripcion: categoria.descripcion })
    .then(response => {
      console.log(response);
    })
    .catch(error => {
    ...
    categoriaService.update(id, { nombre: categoria.nombre, descripcion: categoria.descripcion })
    .then(response => {
      console.log(response);
    })
    .catch(error => {
  ...
  return (
    <div>
      <Card>
        ...
        <form className="mt-5 space-y-4 w-2/5 mx-auto" onSubmit={handleSubmit}>
          <div>
