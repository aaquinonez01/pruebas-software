              ...
              categorias.map(item => (
                <TableRow key={item.id}>
                  ...
                  <TableCell className="flex gap-3">
                    <Link className="text-white bg-blue-500 hover:bg-blue-600 px-4 py-2 rounded" to={`/categorias/${item.id}`}>
                      Editar
                    </Link>
                    <button className="text-white bg-red-500 hover:bg-red-600 px-4 py-2 rounded" onClick={()=>handleDelete(item.id)}>
                      Eliminar
                    </button>
                  </TableCell>
                </TableRow>
